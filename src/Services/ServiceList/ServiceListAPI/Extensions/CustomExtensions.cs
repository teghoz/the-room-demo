...
using TheRoom.BuildingBlocks.EventBusRabbitMQ;
using TheRoom.BuildingBlocks.EventBusServiceBus;
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddEntityFrameworkSqlServer()
                .AddDbContext<ServiceListContext>(options =>
            {
        ...
        public static IServiceCollection AddIntegrationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            if (configuration.GetValue<bool>("AzureServiceBusEnabled"))
            {
                ...
                {
                    var settings = sp.GetRequiredService<IOptions<ServiceListSettings>>().Value;
