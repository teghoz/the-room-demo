    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblServiceListItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblServiceListItemPromos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblServiceListItemPromos_tblServiceListItems_ServiceListItemId",
                        column: x => x.ServiceListItemId,
                        principalTable: "tblServiceListItems",
                        principalColumn: "Id",
